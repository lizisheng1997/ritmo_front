<template>
  <view class="content membersIntroduction">
    <view class="top">
      ...
      <image
        class="shield"
        src="/@/static/community/pingbi.png"
        @click="
          () => {
      ...
      <view class="p0-35">
        ...
        <view
          class="cards flex mt25"
          v-if="state.phone || state.email">
          <text
            class="card mr35"
            v-if="state.phone"
            >{{ state.phone }}</text
      ...
      <view class="myreply p0-35 mt35">
        <view
          ...
          <view class="article flex">
            <image
              class="banner mr20"
              :src="item.post_imagesArr[0]"
              v-if="item.post_imagesArr?.length"></image>
            <view class="info">
